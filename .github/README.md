...
<div align="center">
  ...
  <a href="https://www.github.com/lucasvtiradentes/biacaminha.com.br/commits/master"><img src="https://img.shields.io/github/last-commit/lucasvtiradentes/biacaminha.com.br?color=green&label=updated"></a>
  <br>
  ...
  <a href="https://github.com/lucasvtiradentes/biacaminha.com.br#contributing"><img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat" alt="contributions" /></a>
</div>
...
This is a brazilian senator website with an API and a admin page to update it's content.
...
&nbsp;&nbsp;&nbsp;✔️ Admin panel to manage the site's content, like articles, project numbers, etc;<br>
&nbsp;&nbsp;&nbsp;✔️ Dark/Light theme switch;<br>
&nbsp;&nbsp;&nbsp;✔️ API to manage update and fetch requests with ease;<br>
&nbsp;&nbsp;&nbsp;✔️ Advanced animation effects that run when scrolling the pages down;<br>
&nbsp;&nbsp;&nbsp;✔️ Flickr api connection to get the most recent posted photos;<br>
  ...
  <table>
    ...
    <tr>
      ...
      <td align="center">
        ...
        <a target="_blank" href="https://ejs.co/"><img src="https://img.shields.io/badge/EJS-607026?logo=ejs&logoColor=white"></a>
      </td>
    </tr>
    <tr>
      <!-- <td rowspan="2">Main</td> -->
      <td>Secondary</td>
      <td align="center">
        <a target="_blank" href="https://www.w3.org/html/"><img src="https://img.shields.io/badge/html5-%23E34F26.svg?logo=html5&logoColor=white"></a>
        <a target="_blank" href="https://www.w3schools.com/css/"><img src="https://img.shields.io/badge/css3-%231572B6.svg?logo=css3&logoColor=white"></a>
      </td>
    </tr>
    <!-- <tr> -->
...
- ejs          # package to reuse pices of html code
- express      # backend server package
- mongodb      # package to deal with mongodb database
- node-fetch   # fetch package to make https requests
...
- [Github issues](https://github.com/lucasvtiradentes/biacaminha.com.br/discussions)
